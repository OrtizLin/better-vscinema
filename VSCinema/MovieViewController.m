...
-(void)loadView{
    ...
    navItem.title = NSLocalizedString(@"Select theater",nil);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MovieListViewController *detailview = [MovieListViewController alloc];
    detailview.cinemaID = cinema[indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    for (NSObject *object in enumeratorKey) {
        ...
        NSString *cinemaforKey = [objectforKey valueForKey:@"cinemaId"];
        [cinema addObject:cinemaforKey];
